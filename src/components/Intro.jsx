...
function Intro() {
  const onButtonClick = () => {
    ...
    fetch('SALIPANDE_CV.pdf').then((response) => {
      response.blob().then((blob) => {
        ...
        alink.href = fileURL;
        alink.download = 'SALIPANDE_CV.pdf';
        alink.click();
      });
    });
  };
  return (
    <div id="intro" className="flex justify-center items-center flex-col py-20">
      <div className="text-center">
        <h1 className="text-4xl md:text-4xl mb-3 md:mb-5 text-black  dark:text-white font-semibold">
          HELLO, I'M{' '}
